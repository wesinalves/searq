 <div class='col-md-9'>
  ...
  <img src="{{Storage::url($collection->objects()->where('type','jpeg')->first()->path)}}" class="rounded float-right img-thumbnail" alt="{{Storage::url($collection->objects()->where('type','jpeg')->first()->path)}}" style="width:150px">
  @endif
